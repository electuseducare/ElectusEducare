...
@Controller
public class AdminCreateSelQuesAndFilesWithoutSlotExamController {

	private static final Logger logger = LoggerFactory.getLogger(AdminCreateSelQuesAndFilesWithoutSlotExamController.class);
	...
	@RequestMapping("/load-createSelQuesAndFilesWithoutslotExam")
	public String selectedQuestionsExam(Model model, HttpSession ses, AdminCategory ad,HttpServletRequest req) {
		...
		model.addAttribute("setselectedquesfilesexam", ad);

		return "AdminCreateSelQuesAndFilesWithoutSlotExam";

	}

	@RequestMapping(value = "/insert-withoutSlotSelQuesAndFilesExam", method = RequestMethod.POST)
	public String insertSelectedgivenExam(Model model, AdminCategory ad, HttpServletRequest req, HttpSession ses)
		...
		return "redirect:/load-withoutSlotSelQuesAndFilesCreatedExam";

	}

	@RequestMapping(value = "/load-withoutSlotSelQuesAndFilesCreatedExam", method = RequestMethod.GET)
	public String finalCreateExamPage(Model model, HttpServletRequest req, HttpSession ses) {
		...
		return "AdminSuccessSelQuesAndFilesNoSlot";
	}
