...
<html>
   <head>
      ...
      <script src="${pageContext.request.contextPath}/theme/js/AdminCreateExamFormValidations2.js"></script>
      <style type="text/css">
         .select,
         .chosen-select,
   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         ...
         <c:if test="${smsg==null}" >
            <c:if test="${emsg==null}" >
               <form:form modelAttribute="loadexamdetails" action="insert-copyExamForm">
                  ...
                  <div id="msform">
                     ...
                     <form:input class="form-control"  path="marksperqn" id="marksperqn" value="${marksperqustype}" placeholder="Marks per Question" onkeypress="return isNumberKey(event);"  maxlength="2" readonly="true"/> 
                     </div>	
                     ...
                     <fieldset>
                        ...
                        <div class="col-md-12 col-sm-12" style="float: left;">
                           ...
                           <div class="form-group col-md-6 col-sm-6">
                              ...
                              <form:input path="starttime" type="time" value="${prevstarttime}" class="form-control" id="slotstarttime" placeholder="HH:MM:SS" />
                           </div>
                        </div>
                        <div class="col-md-12 col-sm-12" id="deceased">
                           ...
                           <div class="form-group col-md-6 col-sm-6">
                              ...
                              <form:input type="time"  path="endtime" value="${prevendtime}" class="form-control" id="slotexamendtime" placeholder="HH:MM:SS"  onchange="getexamdurations();"/>
                           </div>
                        </div>
                        <div class="col-md-12 col-sm-12">
                           <label for="examtime" > Test Duration </label>
                           <form:input class="form-control" path="examtime" id="examduration" value="${prevtestduration}"  readonly="true" />
                        </div>
