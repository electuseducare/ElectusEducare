...
<html>
   <head>
      ...
      <%@include file="ResumeExamRRBJsScripts1.jsp"%>
      <%@ include file="resumeextendscripts.jsp" %>
   ...
   <body>
      ...
      <header id="header">
         ...
         <img src="${pageContext.request.contextPath}/theme/images/weblogo.jpg"
            ...
            onmouseout="myPopUpImageMouseOut()" />
         <span
      ...
      <header id="examheader">
         <div class="innertube">
            ...
            </span> <span style="text-align: right; float: right;">  <span style=" text-align: right;float: right;">
	...
	<div href="#nogo" id="keyPad_Help" class="help_back" onclick="openHelpCalcContent();" style="color: white"><b>Help</b></div>
         ...
         <form:form modelAttribute="qp" id="springform" method="POST"
            ...
            <c:forEach items="${model1.qp}" var="subrow" varStatus="loop2">
              ...
              <span
               ...
               Type</b>: ${row1.typeOfQuestion}</font></td>
               ...
               <font style="color: black"> | Negative Marks </font> <font
                  color="red"> ${row1.negative_marks}</font></td>
               </tr>
               </table>
               </div>
               </div>
               ...
               <c:when	test="${row1.typeOfQuestion == 'Numerical Ability'}">
               <c:if test="${integertypeval eq 0}">
               <tr>
               <td width="95%" align="left" valign="baseline">
               <c:if test="${row1.selected_answer eq null}">
      ...
      <div id="myModal3" class="modal3">
         ...
         <div class="modal-content3">
            ...
            <div class="modal-body">
               ...
               <div >
                  <p>1.Total duration of the examination is <label>${examtime} HOURS.</p>
