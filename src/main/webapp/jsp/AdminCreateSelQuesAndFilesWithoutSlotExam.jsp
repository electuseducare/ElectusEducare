...
<html>
   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         ...
         <c:if test="${smsg==null}" >
            <c:if test="${emsg==null}" >
               <form:form  name="AddRoleform" method="post" action="insert-withoutSlotSelQuesAndFilesExam"  modelAttribute="setselectedquesfilesexam" >
                  <div id="msform">
                     <ul id="progressbar">
      ...
      <script>
         ...
         var slotexamenddate1 = document.getElementById('examduration').value;
         var regexp = new RegExp(/^([0-2][0-3]):([0-5][0-9]):([0-5][0-9])$/);
         if(regexp.test(slotexamenddate1)==false){
