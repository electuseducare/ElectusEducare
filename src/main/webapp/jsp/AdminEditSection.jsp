   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#" >MODIFY SECTION</a></li>
            <li ><a href="load-DeleteSectionform" >DELETE SECTION</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;"><a href="load-Editsectionform"><img border="0" alt="W3Schools" src="${pageContext.request.contextPath}/theme/images/edit.jpg" width="40" height="40" ></a></div>
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processsectionform"  modelAttribute="categorylistvalue" >
                     ...
                     <TR>
                        ...
                        <TD width="80%" align="left">
                           <c:if test="${buttonid eq 0}">
                              <center>
                                 <h4 style="color:red">You don't have any sections available to update</h4>
                              </center>
                           </c:if>
                                 ...
                                 <c:forEach items="${categorylistvalue.categorylist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       ...
                                       <TD align="left">
                                          ...
                                          <form:hidden  path="categorylist[${loop.index}].hiddenclassname" value="${editdetails.categoryname}"/>
                                       </TD>
                                       <TD align="center"> ${editdetails.sectionid}  </TD>
                                       <TD style="padding: 10px" align="center">
                                          <form:input path="categorylist[${loop.index}].sectioncheckname" id="sect" name="category123" value="${editdetails.section}" class="form-control" placeholder="Enter Section"  style="width:100%;margin-left:10px;" onKeyPress="return ValidateAlpha(event);" />
