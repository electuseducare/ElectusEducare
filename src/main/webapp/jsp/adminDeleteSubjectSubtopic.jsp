   ...
   <body>
      ...
      <div style="width:65%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li ><a href="load-editsubjectsubtopic" >ADD SUBJECT SUB TOPICS</a></li>
            ...
            <li class="active" ><a href="#" >DELETE SUBJECT SUB TOPICS</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-deletesubjectsubtopic">
         ...
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            <form:form  method="post" action="delete-subjectsubtopiclist"  modelAttribute="SubjectTopicForm" >
               <center>
               ...
               <c:if test="${smsg==null}" >
                  ...
                  <div class="col-md-12 col-sm-12" id="subtopicnamediv" style="display: none;">
                     ...
                     <form:input path="subtopicnametext" id="subtopicnametext" class="form-control" readonly="true"/>
                  </div>
                  <div class="row"></div>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Delete Subject Sub-Topic</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to delete Subject Sub-Topic? </td>
                           </tr>
                           <tr>
