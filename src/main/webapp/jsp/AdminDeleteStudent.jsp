   ...
   <body>
      ...
      <div style="width: 75%; float:left; background-color: #ffffff;">
         ...
         <div class="col-sm-12" style="border: 0px solid grey; margin-left:0px; padding: 0.50em; width: 100%;background-color:#DFE2DB;  overflow-x:scroll;">
            <form:form  name="EditRoles" method="post" action="load-processstudentdelete"  modelAttribute="studentlistvalue" >
               <table id="example" class="display" cellspacing="0" width="100%">
                  <thead>
                     <c:if test="${buttonid eq 0}">
                        <center>
                           <h4 style="color:red">You don't have any students available to delete</h4>
                        </center>
                     </c:if>
               ...
               <div id="finishabc" style="overflow:hidden;">
                  <div id="popupContact" >
                     <div class="panel" style="width: 100%; background-color: #117584;">
                        <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Delete Student</div>
                     </div>
                     <table width="100%" height="65%">
                        <tr>
                           <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to delete Student? </td>
                        </tr>
                        <tr>
