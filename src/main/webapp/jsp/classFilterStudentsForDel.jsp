   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active" ><a href="load-classfilterstudentsfordel" >DELETE STUDENT</a></li>
         </ul>
         <div class="panel panel-info">
            <div class="panel-heading">
               <center><b>Please select class  and section to delete Students.</b></center>
            </div>
         </div>
         <div class="row"></div>
         <h4 style="color: green;text-align: center;">${smsg}</h4>
         <h4  style="color: red;text-align: center;">${emsg}</h4>
               <form:form modelAttribute="filter" method="GET" action="load-DeleteStudentform" >
               ...
               <form:select path="sectionid" id="selsectionid" class="form-control1"  required="required" >
