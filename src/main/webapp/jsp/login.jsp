      ...
      <%
         ...
         if(session != null && !session.isNew()) {
         	if(session.getAttribute("userrole")!=null){
         		response.sendRedirect("load-welcomeUser");
         	}
         } else {
         ...
         <div class="modal-dialog"  style="box-shadow: none;">
            <div class="modal-content" style="box-shadow: none;">
               <div class="modal-header" style="background-color: #428BCA;color:white">
                  <label style="font-size: 18px; color: white;">Login to <%=session.getAttribute("getschool") %></label> 
               </div>
               <div class="form-group" style="color:red;" id ="otperror">  </div>
               <div class="modal-body" style="overflow:auto">
                  <form:form modelAttribute="form" method="POST" action="load-loginform" id="formnames">
