               ...
               <div class="container">
                  ...
                  <div class="navbar-collapse collapse ">
                     <ul class="nav navbar-nav" >
                        ...
                        <li><a href="#" style="color: white;">Material</a></li>
         ...
         <div class="container">
            <div class="col-lg-12">
               <div class="aligncenter">
                  <h2 class="aligncenter">Material</h2>
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="textbox">
                     <h3> <a href="#planning14" id="planning" style="text-decoration: none;">IIT-JEE foundation course book (Paper back/ Tablet P.C)</a></h3>
                     <p>Extensive course book material is provided in the Teaching Order.<a href="#" style=" display: block; width: 120px; height: 30px;background: #4E9CAF; padding: 5px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-transform: uppercase;text-decoration: none;">view more</a></p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="textbox">
                     <h3><a href="#planning15" id="planning11" style="text-decoration: none;">IIT-JEE foundation work book(Paper back/ Tablet P.C)</a></h3>
                     <p>The questions are in accordance with the recent IIT exams.<a href="#" style=" display: block; width: 120px; height: 30px;background: #4E9CAF; padding: 5px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-transform: uppercase;text-decoration: none;">view more</a></p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="textbox">
                     <h3><a href="#planning16" id="planning12" style="text-decoration: none;">NEET foundation course book(Paper back/ Tablet P.C)</a></h3>
                     <p>Extensive course book material is provided in the Teaching Order.<a href="#" style=" display: block; width: 120px; height: 30px;background: #4E9CAF; padding: 5px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-transform: uppercase;text-decoration: none;">view more</a></p>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div class="textbox">
                     <h3><a href="#planning17" id="planning13" style="text-decoration: none;">NEET foundation work book(Paper back/ Tablet P.C)</a></h3>
                     <p>The questions are in accordance with the recent NEET exams.<a href="#" style=" display: block; width: 120px; height: 30px;background: #4E9CAF; padding: 5px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-transform: uppercase;text-decoration: none;">view more</a></p>
                  </div>
               </div>
            </div>
         </div>
