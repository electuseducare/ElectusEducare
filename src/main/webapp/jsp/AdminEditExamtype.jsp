   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#" >MODIFY EXAMTYPE</a></li>
         ...
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processExamtypeform"  modelAttribute="categorylistvalue" >
                     ...
                     <TR>
                        ...
                        <TD width="90%" align="left">
                           <c:if test="${buttonid eq 0}">
                              <center>
                                 <h4 style="color:red">You don't have any examtypes available to update</h4>
                              </center>
                           </c:if>
                           <TABLE id="editexamtype" class="display" cellspacing="0" width="100%">
                              <thead>
                                 <c:if test="${buttonid eq 1}">
                                    <TR>
                                       <TH>No</TH>
                                       <TH style="text-align:center;">Eamtype-ID </TH>
                              ...
                              <tbody>
                                 <c:forEach items="${categorylistvalue.examtypelist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       <TD align="center"> ${loop.index+1}  </TD>
                                       <TD align="center"> ${editdetails.examtype_id}  </TD>
                                       <TD style="padding: 10px" align="center">
                                          <form:input path="examtypelist[${loop.index}].examtype_name"  value="${editdetails.examtype}" class="form-control" placeholder="Enter Examtype" required="required" style="width:100%;margin-left:5px;" maxlength="60" onkeyup="return validatespaces(this.id);"/>
                                          <span style="display:none ">${editdetails.examtype}</span>
                                       </TD>
                                       <TD style="padding: 6px">
                                          <form:checkbox path="examtypelist[${loop.index}].examtypeckeckbox"  id="selectloc${loop.index}"  value="${editdetails.examtype_id}" style="margin-left:74px;"/>
                                       </TD>
                                    </TR>
                                 </c:forEach>
                              </tbody>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Modify Examtype</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to modify Examtype? </td>
                           </tr>
                           <tr>
