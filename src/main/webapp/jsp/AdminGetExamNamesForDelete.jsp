   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            <li class="active"><a href="#">DELETE EXAM</a></li>
            <li ><a href="load-availableExamsToAddRandomQues">SET EXAM WITH RANDOM QUESTIONS</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-availableExamNamesToDelete" style="text-decoration: none;">
            <img border="0" alt="Add Create Exam" src="${pageContext.request.contextPath}/theme/images/delete.jpg" width="40" height="40" style="background-color: skyblue;">
            DELETE EXAM </a>
         </div>
         <div class="row"></div>
         ...
         <h4  style="color: red;text-align: center;">${emsg}</h4>
               ...
               <c:if test="${smsg==null}" >
                  <c:if test="${emsg==null}" >
                     <form:form modelAttribute="getexamnames" action="load-deleteexam">
                      <div class="form-row">
                 ...
                 <form:select path="selectedexam" id="selectedexam" class="chosen-select">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                        <button class="button btn-primary" onclick="return examFormValidation();"> Delete Exam </button>
                        </div>
                     </div>
                    </div>
                    </div>
