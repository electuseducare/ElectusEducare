   ...
   <head>
      ...
      <script type="text/javascript">
         function createExamValidations123() {
         	 var str1 = document.getElementById("questionscount").innerHTML;
         	  var str2 = str1.indexOf("Entered Subject questions:");
         	  if(str2>=0){
         		   alert(str1);
         	       return false;
         		  }
         	  var slotexamenddate = document.getElementById('slotexamenddate').value;
         	  var ngmarks = document.getElementById('ngmarks').value;
         	  ...
         	  if((ngmarks.length<=0) || (ngmarks==null) ||(ngmarks=="") ){
         		  ngmarksmodal.style.display = "block";
         		  return false;
         	}
         	  }
         	  startloader();  
   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            <li class="active"><a href="#">CREATE EXAM WITHOUT SLOT</a></li>
         ...
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-SetExamformwslot" style="text-decoration: none;">
         ...
         <c:if test="${smsg==null}" >
            <c:if test="${emsg==null}" >
               <form:form  name="AddRoleform" method="post" action="insert-ProcessExamFormwithoutslot"  modelAttribute="setexam" >
                  <div id="msform">
                     <!-- progressbar -->
                     <ul id="progressbar">
                     ...
                     <fieldset>
                        ...
                        <div class="col-md-12 col-sm-12" id="deceased">
                           ...
                           <div class="form-group col-md-6 col-sm-6">
                              ...
                              <form:input class="form-control" path="examtime" id="examduration" pattern="([01]?[0-9]|2[0-3])(:[0-5][0-9]){2}" autocomplete="off" required="required" placeholder="HH:MM:SS" title="Time duration accept HH:MM:SS 24hrs format"  />
                           </div>
                        </div>
                        <div class="col-md-12 col-sm-12" id="negativemarksdivs" style="display: none;">
                           <label for="negativemarks"  >  Negative Marks :  </label>
                           <form:input class="form-control"  path="negativemarks1"  placeholer="Negative Marks" id="ngmarks" onkeypress="return validateFloatKeyPress(this,event);" maxlength="4"/>
                        </div>
