   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#">COPY PREVIOUS CREATED EXAM WITHOUT PATTERN SLOT</a></li>
         ...
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            ...
            COPY PREVIOUS CREATED EXAM  WITHOUT SLOT </a>
         </div>
         <div class="row"></div>
               <form:form modelAttribute="getexamnames" action="displayselectedExamDetailsNoslot">
               <div class="form-row">
