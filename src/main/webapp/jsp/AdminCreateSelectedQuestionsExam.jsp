   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#">EXAM WITH SELECTED QUESTIONS</a></li>
         ...
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-createSelectedQuestionsExam" style="text-decoration: none;">
         ...
         <c:if test="${smsg==null}" >
            <c:if test="${emsg==null}" >
               <form:form  name="AddRoleform" method="post" action="insert-SelectedQuestionsForm"  modelAttribute="setselectedquesexam" >
                  <div id="msform">
                     <ul id="progressbar">
