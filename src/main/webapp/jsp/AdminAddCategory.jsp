...
<html>
   <head>
      ...
      <script type="text/javascript">
         function fieldvalidation(){
         	...
         	var examname = document.getElementById('class').value;
   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         ...
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;"><a href="load-categoryform"><img border="0" alt="W3Schools" src="${pageContext.request.contextPath}/theme/images/addicon.jpg" width="40" height="40" style="background-color:#ccf2ff"></a></div>
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="process-categoryform"  modelAttribute="admincategory" >
                  <label style="color:black;font-weight: bold;">Class:</label>
                  <form:input path="category" name="category" id="class" class="form-control" placeholder="Enter Class" required="required"  maxlength="60" autocomplete="off"/>
                  <div class="row"></div>
                  <center><button class="btn-primary" style="background-color: #00a3cc;color:white;width:15%;align-text:center;" onclick="return fieldvalidation();">ADD CLASS</button></center>
               </form:form>
            </c:if>
         </div>
      </div>
