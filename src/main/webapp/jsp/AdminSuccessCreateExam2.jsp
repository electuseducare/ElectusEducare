   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <!--  <li class="active"><a href="#">ADD COMPREHENSION QUESTION FOR EXAM</a></li> -->
         ...
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-availableExamsInAddComph" style="text-decoration: none;">
            ...
            ADD COMPREHENSION QUESTION FOR EXAM </a>
         </div>
         <div class="row"></div>
         <center>
         ...
         <center>
            <a href="load-availableExamsInAddComph"> <button class="btn-primary" style="border:thin;color: white; font-weight: bold; "> Back</button> </a>
         </center>
      </div>
