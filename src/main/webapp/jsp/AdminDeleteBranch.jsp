   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#" >DELETE BRANCH</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;"><a href="load-Deletebranchform"><img border="0" alt="W3Schools" src="${pageContext.request.contextPath}/theme/images/delete.jpg" width="40" height="40" ></a> </div>
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processdeletebranchform"  modelAttribute="deletelistvalue" >
                     ...
                     <TR>
                        ...
                        <TD width="90%" align="left">
                           <c:if test="${buttonid eq 0}">
                              <center>
                                 <h4 style="color:red">You don't have any branches available to delete</h4>
                              </center>
                           </c:if>
                              ...
                              <thead>
                                 <c:if test="${buttonid eq 1}">
                                    <TR>
                                       ...
                                       <TH>&nbsp;&nbsp;&nbsp;Branch Name</TH>
                                       <TH>Select All<input
                                          type="checkbox" id="selectalllocations" value="0"
                                          onclick="selectAllLocations();" style="margin-left: 5px;">
                                       </TH>
                                    </TR>
                                 </c:if>
                              </thead>
                              <tbody>
                                 <c:forEach items="${deletelistvalue.categorylist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       ...
                                       <TD align="left"> ${editdetails.stateid}  </TD>
                                       <TD align="left"> ${editdetails.location} </TD>
                                       <TD align="center"> ${editdetails.branchid}  </TD>
                                       <TD style="padding: 10px" align="center">
                                          <form:input path="categorylist[${loop.index}].branchcheckname" name="category" value="${editdetails.branch}" class="form-control"  readonly="true" style="width:100%;margin-left:10px;"/>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Delete Branch</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to delete Branch? </td>
                           </tr>
                           <tr>
