               ...
               <div class="container">
                  ...
                  <div class="navbar-collapse collapse ">
                     <ul class="nav navbar-nav" >
                        ...
                        <li><a href="#planning6" style="color: white;">Staff-Recruitment & Training</a></li>
         ...
         <div class="container">
            <div class="col-lg-12">
               <div class="aligncenter">
                  <h2 class="aligncenter">Staff Recruitment and Training</h2>
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="textbox" style="height: 170px;">
                     <h3> <a href="#planning6" id="planning6" style="text-decoration: none;">Staff requirement analysis</a></h3>
                     <p>Workloads and staff requirement are planned.. <a href="#" style=" display: block; width: 120px; height: 30px;background: #4E9CAF; padding: 5px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-transform: uppercase;text-decoration: none;">view more</a></p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="textbox" style="height: 170px;">
                     <h3><a href="#planning7" id="planning7" style="text-decoration: none;">Staff procurement and appointment</a></h3>
                     <p>Process for staff procurement and appointment.<a href="#" style=" display: block; width: 120px; height: 30px;background: #4E9CAF; padding: 5px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-transform: uppercase;text-decoration: none;">view more</a></p>
                  </div>
               </div>
               <div class="col-md-4" >
                  <div class="textbox" style="height: 170px;">
                     <h3><a href="#planning8" id="planning8" style="text-decoration: none;">Staff training</a></h3>
                     <p>Staff training is provided.<a href="#" style=" display: block; width: 120px; height: 30px;background: #4E9CAF; padding: 5px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-transform: uppercase;text-decoration: none;">view more</a></p>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div class="textbox" style="height: 170px;">
                     <h3><a href="#planning9" id="planning9" style="text-decoration: none;">Staff skill enrichment</a></h3>
                     <p>For the existing staff , enrichment program is provided.<a href="#" style=" display: block; width: 120px; height: 30px;background: #4E9CAF; padding: 5px;text-align: center;border-radius: 5px;color: white;font-weight: bold;text-transform: uppercase;text-decoration: none;">view more</a></p>
                  </div>
               </div>
            </div>
         </div>
