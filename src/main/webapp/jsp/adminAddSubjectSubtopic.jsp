   ...
   <head>
      ...
      <script type="text/javascript">
         ...
         var getSubtopicsFromClassSubject = function(topicid){
             ...
             $.ajax({
                     url : "load-subtopicsforSubject?classid="+classid+"&subjectid="+subjectid+"&topicid="+topicid,
                     type: "POST",
                     dataType: 'text',
                     success : 
                     function(data) {
   ...
   <body>
      ...
      <div style="width:65%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#" >ADD SUBJECT SUB TOPICS</a></li>
         ...
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-addsubjectsubtopic">
         ...
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            <form:form  method="post" action="insert-subjectsubtopiclist"  modelAttribute="SubjectTopicForm" >
               <center>
               ...
               <c:if test="${smsg==null}" >
                  ...
                  <div class="col-md-12 col-sm-12" id="topiiddiv">
                     ...
                     <form:select path="subtopicnames" id="subtopicnames" class="form-control" onchange="displaytopicnametextBox(this.id)">
                  ...
                  <div class="col-md-12 col-sm-12" id="buttondiv">
                     ...
                     <div class="col-md-6 col-sm-6" id="buttondiv">
                        <button class="btn-primary" style="background-color: #00a3cc;color:white;align-text:center;" > ADD SUB-TOPICS </button>
                     </div>
                  </div>
               </c:if>
            </form:form>
