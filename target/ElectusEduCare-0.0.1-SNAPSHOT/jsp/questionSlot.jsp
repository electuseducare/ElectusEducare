...
<html>
  ...
  overflow: auto;
      ...
      <script type="text/javascript">
         ...
         var urls="load-questionid-bookmarkSlot?ver="+qid+"&subjectid="+subjectid+"&examname="+examname+"&locationid="+locationid+"&classid="+classid+"&sectionid="+sectionid+"&branchid="+branchid+"&studentid="+studentid;
	...
	<body>
      ...
      <header id="header">
         ...
         <%--   <span style="color: white; font-size: 28px; font-weight: bold">RRB ${curyear}
            </span> --%>
      </header>
         ...
         <form:form modelAttribute="qp" id="springform" method="POST" action="load-qform">
            ...
            <c:forEach items="${model1.fqp}" var="subrow" varStatus="loop2">
               ...
               <%-- <div class="shadow3">
                  ...
                  <table>
                  <tr>
                  <td  style="padding-bottom: 20px;"><a href="#" class="answeredbtn" id="${subrow.subjectid}_answeredbtn"></a>Answered</td>
                  <td>&nbsp;&nbsp;</td>
                  <td  style="padding-bottom: 20px;"><a href="#" class="notansweredbtn" id="${subrow.subjectid}_notansweredbtn"></a>Not Visited</td>
                  
                  </tr>
                   <tr>
                  <td  style="padding-bottom: 25px;"><a href="#" class="notansweredvisitedbtn" id="${subrow.subjectid}_visnotansweredbtn">N</a>Visited But Not Answered</td>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td  style="padding-bottom: 25px;"><a href="#" class="currentques" id="${subrow.subjectid}_currentqnbtn">C</a>Current Question</td>
                  
                  </tr>
                  
                     <tr>
                  <td><a href="#" class="markforreviewansw" id="${subrow.subjectid}_markasrevansbtn">0</a>Answered &amp; Mark for Review</td>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td><a href="#" class="markforreview" id="${subrow.subjectid}_markasrevnotansbtn" >0</a>Mark for Review</td>
                  
                  </tr>
                  <tr><td colspan="3" class="nxtsubje" style="background-color: #4E85c5; height: 30px;  line-height: 30px; color: white;font-weight: bold;text-align: center;cursor: pointer;" onclick="viewNextTabSubjects();">
                  Click &amp; View Next Subject Questions
                  </td></tr>
                  </table>
                  </div> --%>
               <%-- 	<div class="shadow2">
                  <Span></Span>
                  <div id="galleryalt_<%=tempval%>" class="paginationstyle" style="text-align: left; width: 27%;background-color: #E5F6FD">
                  <a href="#" type="button" rel="previous" class="btn btn-info" style="display:none; color: white; border-radius: 0px;height: 25px;padding-bottom: 28px">Previous</a>
                  <span class="flatview"></span>
                  <div class="rightshadowbtns">
                  <a href="#" rel="next" class="btn btn-info" style="color: white; border-radius: 0px; height: 25px;padding-bottom: 28px; background-color: #0C7CD5">Save&amp;Next</a>
                  </div>
                  </div>
                  </div> --%>
               ...
               <div class="nano-pane" style="display: none;"><div class="nano-slider" style="height: 228px; transform: translate(0px, 0px);"></div></div></div>
               </div>
               <div class="rightshadowbtns">
               ...
               <br>
               <span class="vKeyboardSplKeys" style="border-radius: 6px;" onclick="clearAllValues('list[${optionsloop}].options');removeRadiobuttonSelection('list[${optionsloop}].options',${row1.question_id},${row1.subjectid},${row1.questionrowid},${quesno},'#101010');">Clear All</span><br>
               </div>
               </div>
               </div>
               </td>
                  ...
                  <tr>
                     <td align="left" width="50%" valign="bottom">
                        <button class="button btn-primary" id="finishbutton"
                           ...
                           onclick="stopFinishTestTime();this.disabled=true;startloader()">Finish
                        Test</button>
                     </td>
                     <td align="right" width="50%" valign="bottom">
                        <button class="button btn-primary"
                           style="margin-top: 40px; margin-right: 180px; background-color: #0E8DE2; color: white; font-weight: bold;"
                           id="cancelFinish" onclick="return cancel_Finish();startloader()">Cancel</button>
                     </td>
                  </tr>
               </table>
            </div>
