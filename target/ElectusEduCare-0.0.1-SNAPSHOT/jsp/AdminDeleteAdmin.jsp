   ...
   <body>
      ...
      <div style="width: 75%; float:left; background-color: #ffffff;">
         ...
         <div class="col-sm-12" style="border: 0px solid grey; margin-left:0px; padding: 0.50em; width: 100%;background-color:#DFE2DB;  overflow-x:scroll;">
            <form:form  name="EditRoles" method="post" action="load-processAdmindelete"  modelAttribute="studentlistvalue" >
                  ...
                  <table id="example" class="display" cellspacing="0" width="100%">
                     <thead>
                        <c:if test="${buttonid eq 0}">
                           <center>
                              <h4 style="color:red">You don't have any admins available to delete</h4>
                           </center>
                        </c:if>
                     ...
                     <tbody>
                        <c:forEach items="${studentlistvalue.studentformlist}" var="editdetails" varStatus="loop">
                           <tr>
                              ...
                              <td style="font-weight: bold;">
                                 <form:input path="studentformlist[${loop.index}].firstname"  readonly="true"/>
                                 <span style="display:none;">${editdetails.firstname}</span>
                              </td>
                              <td style="font-weight: bold;">
                                 <form:input path="studentformlist[${loop.index}].lastname" readonly="true"/>
                                 <span style="display:none;">${editdetails.lastname}</span>
                              </td>
                              <td style="font-weight: bold;">
                                 <form:input path="studentformlist[${loop.index}].username" id="selectloc${loop.index}" readonly="true"/>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Delete Admin</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to delete Admin? </td>
                           </tr>
                           <tr>
