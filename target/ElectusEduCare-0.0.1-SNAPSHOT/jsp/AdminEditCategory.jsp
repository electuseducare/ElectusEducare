   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#" >MODIFY CLASS</a></li>
            <li ><a href="load-Deletecategoryform" >DELETE CLASS</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;"><a href="load-Editcategoryform"><img border="0" alt="W3Schools" src="${pageContext.request.contextPath}/theme/images/edit.jpg" width="40" height="40" ></a></div>
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processcategoryform"  modelAttribute="categorylistvalue" >
                     ...
                     <TR>
                        ...
                        <TD width="90%" align="left">
                           <c:if test="${buttonid eq 0}">
                              <center>
                                 <h4 style="color:red">You don't have any classes available to update</h4>
                              </center>
                           </c:if>
                           <TABLE id="editclass" class="display" cellspacing="0" width="100%">
                              <thead>
                              ...
                              <tbody>
                                 <c:forEach items="${categorylistvalue.categorylist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       ...
                                       <TD align="center"> ${editdetails.categoryid}  </TD>
                                       <TD style="padding: 10px" align="center">
                                          <form:input path="categorylist[${loop.index}].categoryname" value="${editdetails.category}" class="form-control"  placeholder="Enter Class"  style="width:100%; margin-left:5px;" maxlength="60"  />
                                          <span style="display: none">${editdetails.category}</span>
                                       </TD>
                                       <TD style="padding: 6px">
                                          <form:checkbox path="categorylist[${loop.index}].category"  id="selectloc${loop.index}"  value="${editdetails.categoryid}" style="margin-left:74px;"/>
                                       </TD>
                                    </TR>
                                 </c:forEach>
                              </tbody>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Modify Class</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to modify Class? </td>
                           </tr>
                           <tr>
