   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li ><a href="load-EditQuestionlevelform" >MODIFY QUESTION LEVEL</a></li>
            <li class="active"><a href="#" >DELETE QUESTION LEVEL</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-DeleteQuestionlevelform">
         ...
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processdeleteQuestionlevelform"  modelAttribute="deletelistvalue" >
                     ...
                     <TR>
                        ...
                        <TD width="60%" align="left">
                           <c:if test="${buttonid eq 0}">
                              <center>
                                 <h4 style="color:red">You don't have any questionlevels available to delete</h4>
                              </center>
                           </c:if>
                           <TABLE id="deletequestionlevel" class="display" cellspacing="0" width="100%">
                              <thead>
                              ...
                              <tbody>
                                 <c:forEach items="${deletelistvalue.questionlevellist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       <TD align="center"> ${loop.index+1}  </TD>
                                       <TD style="padding: 10px" align="center">
                                          <form:input path="questionlevellist[${loop.index}].quesntion_level"  value="${editdetails.questionlevel}" class="form-control" placeholder="Enter Class" readonly="true" style="width:100%;margin-left:10px;"/>
                                          <span style="display: none">${editdetails.questionlevel}</span>
                                       </TD>
                                       <TD style="padding: 6px">
                                          <form:checkbox path="questionlevellist[${loop.index}].qnlevelckeckbox" id="selectloc${loop.index}"   value="${editdetails.questionleveltypeid}" style="margin-left:76px;"/>
                                       </TD>
                                    </TR>
                                 </c:forEach>
                              </tbody>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">DELETE</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to delete Question Level? </td>
                           </tr>
                           <tr>
