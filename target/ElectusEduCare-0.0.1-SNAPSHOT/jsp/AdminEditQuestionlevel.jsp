   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            <li  ><a href="load-addquestionlevel" >ADD QUESTION LEVEL</a></li>
            <li class="active"><a href="#" >MODIFY QUESTION LEVEL</a></li>
            <li ><a href="load-DeleteQuestionlevelform" >DELETE QUESTION LEVEL</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-EditQuestionlevelform">
         ...
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processQuestionlevelform"  modelAttribute="categorylistvalue" >
                     ...
                     <TR>
                        ...
                        <TD width="80%" align="left">
                           <c:if test="${buttonid eq 0}">
                              <center>
                                 <h4 style="color:red">You don't have any questionlevels available to update</h4>
                              </center>
                           </c:if>
                           <TABLE id="editquestionlevel" class="display" cellspacing="0" width="100%">
                              <thead>
                                 <c:if test="${buttonid eq 1}">
                                    <TR>
                                       <TH >No</TH>
                                       <TH >Question level #</TH>
                                       <TH >Question level Type </TH>
                                       <TH >Select All<input type="checkbox" id="selectalllocations" value="0" onclick="selectAllLocations();" style="margin-left:5px;"> </TH>
                                    </TR>
                                 </c:if>
                              </thead>
                              <tbody>
                                 <c:forEach items="${categorylistvalue.questionlevellist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       <TD align="center"> ${loop.index+1}  </TD>
                                       <TD align="center"> ${editdetails.questionleveltypeid}  </TD>
                                       <TD style="padding: 10px" align="center">
                                          <span style="display: none;"> ${editdetails.questionlevel} </span>
                                          <form:input path="questionlevellist[${loop.index}].quesntion_level" id="questionlevellist[${loop.index}].quesntion_level"  value="${editdetails.questionlevel}" class="form-control" placeholder="Enter Questionlevel" required="required" style="width:100%;margin-left:5px;" onkeypress="return onlyAlphabets(event,this);" maxlength="60" onkeyup="return validatespaces(this.id);"/>
                                       </TD>
                                       <TD style="padding: 6px">
                                          <form:checkbox path="questionlevellist[${loop.index}].qnlevelckeckbox"  id="selectloc${loop.index}"  value="${editdetails.questionleveltypeid}" style="margin-left:74px;"/>
                                       </TD>
                                    </TR>
                                 </c:forEach>
                              </tbody>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Modify Questionlevel</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to modify Questionlevel? </td>
                           </tr>
                           <tr>
