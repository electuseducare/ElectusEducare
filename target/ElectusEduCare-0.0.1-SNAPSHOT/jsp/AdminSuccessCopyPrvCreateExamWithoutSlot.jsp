   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="load-availableExamsInCopyCreateExamNoslot">COPY PREVIOUS CREATED EXAM PATTERN WITHOUT SLOT</a></li>
         ...
         <center>
            <a href="load-availableExamsInCopyCreateExamNoslot"> <button class="btn-primary" style="border:thin;color: white; font-weight: bold; "> Back to Copy Create Exam</button> </a>
         </center>
          <div class="row"></div>
         <center>
