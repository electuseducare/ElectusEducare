   ...
   <head>
      ...
      <script type="text/javascript">
         function fieldvalidation(){
         	...
         	var examname = document.getElementById('section').value;
   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            <li class="active" ><a href="#" >ADD SECTION</a></li>
            <li ><a href="load-Editsectionform" >MODIFY SECTION</a></li>
            <li ><a href="load-DeleteSectionform" >DELETE SECTION</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;"><a href="load-sectionform"><img border="0" alt="W3Schools" src="${pageContext.request.contextPath}/theme/images/addicon.jpg" width="40" height="40" style="background-color: skyblue;"></a></div>
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="process-sectionform"  modelAttribute="adminsection" >
                  <label>Class:</label>
                  ...
                  <form:input path="section" name="section" id="section" class="form-control" placeholder="Enter Section"  required="required" maxlength="60" autocomplete="off"/>
                  <div class="row"></div>
                  <center><button class="btn-primary" style="background-color: #00a3cc;color:white;width:15%;align-text:center;" onclick="return fieldvalidation();">ADD SECTION</button></center>
               </form:form>
            </c:if>
         </div>
      </div>
