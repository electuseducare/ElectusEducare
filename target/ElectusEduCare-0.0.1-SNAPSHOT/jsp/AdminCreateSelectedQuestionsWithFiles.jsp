...
<html>
   <head>
      ...
      <title>Admin Create Selected Questions Exam</title>
      ...
      <script src="${pageContext.request.contextPath}/theme/js/AdminCreateExamwitthSelFilesAjaxScripts.js"></script>
      ...
      <script type="text/javascript">
         $(document).ready(function(){
            ...
            for(var j = 0; j < sublist.length; j++) {
            	...
            	//Get Topics
            	var file1 = $('#impfiles1_'+subjectid).val();
            	if (file1 == "") {
            	    alert("Please enter File Name");
            	    return false;
            	  }
            	//Get Sub Topics
            	var file2 = $('#impfiles2_'+subjectid).val();
            	if (file2 == "") {
            	    alert("Please enter File Name");
            	    return false;
            	  }
                 tempval=subjectid+"-"+file1+"__"+file2+"@";
                ...
                $.ajax({
                        url : "load-GetQuestionsBasedOnFilesAndSubExamtp?subjectid="+subidval+"&examtypeid="+examtypeid+"&totalval="+totalval,
   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="load-createSelectedQuestionsExamwithFiles">SELECTED FILES</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-createSelectedQuestionsExamwithFiles" style="text-decoration: none;">
            ...
            EXAM WITH SELECTED QUESTIONS AND FILES </a>
         </div>
         <center>
         ...
         <c:if test="${smsg==null}" >
            <c:if test="${emsg==null}" >
               <form:form  name="AddRoleform" method="post" action="insert-SelectedQuestionsAndFilesForm"  modelAttribute="setselectedquesexam" >
                  <div id="msform">
                     <ul id="progressbar">
