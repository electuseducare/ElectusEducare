      ...
      <div style="width:70%; float:left; background-color: #ffffff;">
         ...
         <div class="col-sm-12" style="padding: 4px; float: left; margin-left: 200px;">
            <div class="side-by-side clearfix">
               <form:form modelAttribute="adminreport" action="processofflinereports">
                  ...
                  <button class="button btn-primary" onclick="return examFormValidation();"> Generate Reports </button>
                  <div class="row"></div>
                  <div class="row"></div>
                  <div class="row"></div>
