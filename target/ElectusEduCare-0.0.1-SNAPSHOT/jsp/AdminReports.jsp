...
<html>
   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <table>
            <tr>
               <td class="center"><a href="load-allindiamarksAnalysis" onclick="startloader()">
               ...
               <td class="center"><a href="load-QuestionWiseErrorReport" onclick="startloader()">
               ...
               <td class="center"><a href="load-subjectwiserightwrongreportform" onclick="startloader()">
            ...
            <tr>
               <td class="center"><a href="load-campuswiseerrorreport" onclick="startloader()">
               ...
               <td class="center"><a href="load-Statewiseerrorreport" onclick="startloader()">
               ...
               <td class="center"><a href="load-subjectwisemarksranges" onclick="startloader()">
            ...
            <tr>
               <td class="center"><a href="SubjectWiseReport" onclick="startloader()">
               ...
               <td class="center"><a href="load-fiftypercentmarkssubjectwise" onclick="startloader()">
               ...
               <td class="center"><a href="load-presentprevmarksAnalysis" onclick="startloader()">
            ...
            <tr>
               <td  class="center"><a href="load-below100rankssubjectwiseincampus" onclick="startloader()">
               ...
               <td  class="center"><a href="load-sectionwiseattendiesAvgs" onclick="startloader()">
               ...
               <td  class="center"><a href="load-QuestionwiseTimeAnalysis" onclick="startloader()">
                  <img border="1" alt="ORDER OF ATTEMPTED QUESTIONS" id="rcorners2" src="${pageContext.request.contextPath}/theme/images/analysis.jpg" >
                  </a><br><strong >ORDER OF ATTEMPTED QUESTIONS</strong>
               </td>
            </tr>
         </table>
      </div>
