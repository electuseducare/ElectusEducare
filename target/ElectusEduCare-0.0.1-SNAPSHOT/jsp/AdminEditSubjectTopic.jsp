...
<html>
   <head>
      ...
      <title>Modify Subject Topics</title>
      ...
      <script type="text/javascript">
         ...
         var getTopicsFromTopicTable = function(subjectid){
             ...
             $.ajax({
                     url : "load-topicsfromtopicsforEdit?classid="+classid+"&subjectid="+subjectid,
                     type: "POST",
                     dataType: 'text',
                     success : 
                     function(data) {
         ...
         var getTopicNamesforEdit = function(topicid){
             ...
             $.ajax({
                     url : "load-topicnamefromtopicsforEdit?classid="+classid+"&subjectid="+subjectid+"&topicid="+topicid,
                     type: "GET",
                     dataType: 'json',
                     success : 
                     function(data) {
   ...
   <body>
      ...
      <div style="width:65%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active" ><a href="#" >MODIFY SUBJECT TOPICS</a></li>
         ...
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  method="post" action="update-subjecttopiclist"  modelAttribute="SubjectTopicForm" >
                  ...
                  <div class="col-md-12 col-sm-12" id="buttondiv">
                     ...
                     <div class="col-md-6 col-sm-6" id="buttondiv">
                        <button class="btn-primary" style="background-color: #00a3cc;color:white;align-text:center;" onclick="return finish_div_show();addTopicsvalidation();"> UPDATE</button>
                     </div>
                  </div>
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Modify Subject Topic</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to modify Subject Topic? </td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                              <td align="left" width="50%" valign="bottom">  
                                 <button class="button btn-primary" style="margin-top:40px; margin-left:180px;background-color:#0E8DE2;color: white; font-weight: bold; " name="actionform" value="finishtest" onclick="stopFinishTestTime();"> UPDATE</button>
                              </td>
