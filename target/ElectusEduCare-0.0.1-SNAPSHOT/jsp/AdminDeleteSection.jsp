   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            <li  ><a href="load-sectionform" >ADD SECTION</a></li>
            <li ><a href="load-Editsectionform" >MODIFY SECTION</a></li>
            <li class="active"><a href="#" >DELETE SECTION</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;"><a href="load-DeleteSectionform"><img border="0" alt="W3Schools" src="${pageContext.request.contextPath}/theme/images/delete.jpg" width="40" height="40" ></a> </div>
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processdeletesectionform"  modelAttribute="deletelistvalue" >
                     ...
                     <TR>
                        ...
                        <TD width="90%" align="left">
                           <c:if test="${buttonid eq 0}">
                              <center>
                                 <h4 style="color:red">You don't have any sections available to delete</h4>
                              </center>
                           </c:if>
                           <table id="deletesection" class="display" cellspacing="0" width="100%">
                              <thead>
                                 <c:if test="${buttonid eq 1}">
                                    <TR>
                                       ...
                                       <TH > &nbsp;&nbsp;&nbsp;Section Name </TH>
                                       <TH>Select All 
                                          <input type="checkbox" id="selectalllocations" value="0" onclick="selectAllLocations();" style="margin-left:5px;">
                                       </TH>
                                    </TR>
                                 </c:if>
                              </thead>
                              <tbody>
                                 <c:forEach items="${deletelistvalue.categorylist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       <TD align="center"> ${loop.index+1}  </TD>
                                       <TD align="center"> ${editdetails.categoryname} </TD>
                                       <TD align="center"> ${editdetails.sectionid}  </TD>
                                       <TD style="padding: 10px" align="center">
                                          <form:input path="categorylist[${loop.index}].sectioncheckname" name="category" value="${editdetails.section}" class="form-control" placeholder="Enter Class" readonly="true" style="width:100%;margin-left:10px;"/>
                                          <span style="display: none;">${editdetails.section}</span>
                                       </TD>
                                       <TD style="padding: 6px">
                                          <form:checkbox path="categorylist[${loop.index}].section" id="selectloc${loop.index}" value="${editdetails.sectionid}" style="margin-left:80px;"/>
                                       </TD>
                                    </TR>
                                 </c:forEach>
                              </tbody>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Delete Section</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to delete Section? </td>
                           </tr>
                           <tr>
