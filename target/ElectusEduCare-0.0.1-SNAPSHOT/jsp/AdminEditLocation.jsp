   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#" >MODIFY LOCATION</a></li>
            <li ><a href="load-DeleteLocationform" >DELETE LOCATION</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;"><a href="load-EditLocationform"><img border="0" alt="W3Schools" src="${pageContext.request.contextPath}/theme/images/edit.jpg" width="40" height="40" ></a></div>
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processLocationform"  modelAttribute="categorylistvalue" >
                     ...
                     <TR>
                        ...
                        <TD width="90%" align="left">
                           <c:if test="${buttonid eq 0}">
                              <center>
                                 <h4 style="color:red">You don't have any locations available to update</h4>
                              </center>
                           </c:if>
                           <TABLE id="editlocation" class="display" cellspacing="0" width="100%">
                              <thead>
                              ...
                              <tbody>
                                 <c:forEach items="${categorylistvalue.categorylist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       ...
                                       <TD align="center" >
                                          ${editdetails.stateid} 
                                          <form:hidden  path="categorylist[${loop.index}].hiddenstatename" value="${editdetails.stateid}"/>
                                       </TD>
                                       <TD align="center"> ${editdetails.locationid}  </TD>
                                       <TD style="padding: 10px" align="center">
                                          <form:input path="categorylist[${loop.index}].loactioncheckvalue" name="category" onKeyPress="return ValidateAlpha(event);" value="${editdetails.location}" class="form-control" placeholder="Enter Location"  style="width:100%;margin-left:10px;"  maxlength="60"/>
                                          <span style="display: none">${editdetails.location}</span>
                                       </TD>
                                       <TD style="padding: 6px">
                                          <form:checkbox path="categorylist[${loop.index}].location" id="selectloc${loop.index}"  value="${editdetails.locationid}" style="margin-left:78px;"/>
                                       </TD>
                                    </TR>
                                 </c:forEach>
                              </tbody>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Modify Location</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to modify Location? </td>
                           </tr>
                           <tr>
