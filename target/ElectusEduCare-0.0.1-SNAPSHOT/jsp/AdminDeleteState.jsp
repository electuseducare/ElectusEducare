   ...
   <body>
      ...
      <div style="width:70%; float:left; background-color: #ffffff">
         <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="#" >DELETE STATE</a></li>
         </ul>
         <div class="panel-heading" style="background-color:#ccf2ff;color:black; font-weight: bold;">
            <a href="load-Deletestateform"><img border="0" alt="W3Schools" src="${pageContext.request.contextPath}/theme/images/delete.jpg" width="40" height="40" > </a>
         </div>
         <div class="panel-body" id="mockTabs" style="background-color:#DFE2DB;">
            ...
            <c:if test="${smsg==null}" >
               <form:form  name="AddRoleform" method="post" action="load-processdeletestateform"  modelAttribute="deletelistvalue" >
                  <TABLE width="100%" style="padding: 6px">
                     <TR>
                        ...
                        <TD width="80%" align="left">
                           ...
                           <TABLE id="deletestate" class="display" cellspacing="0" width="100%">
                              <thead>
                                 ...
                                 <c:forEach items="${deletelistvalue.categorylist}" var="editdetails" varStatus="loop">
                                    <TR>
                                       ...
                                       <TD style="padding: 10px" align="center">
                                          <form:input path="categorylist[${loop.index}].statename" name="category" value="${editdetails.statename}" class="form-control"  readonly="true" style="width:100%;margin-left:10px;"/>
                  ...
                  <div id="finishabc" style="overflow:hidden;">
                     <div id="popupContact" >
                        <div class="panel" style="width: 100%; background-color: #117584;">
                           <div class="panel-heading"  style="font-size: 18px;font-weight: bold; color: #ffffff;">Delete State</div>
                        </div>
                        <table width="100%" height="65%">
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;"> Do you want to delete State? </td>
                           </tr>
                           <tr>
                              <td valign="middle" align="center" colspan="2" style="font-weight: bold; color: #00004d;">If you delete State,the related Location and Branch will also be deleted.. </td>
                           </tr>
                           <tr>
