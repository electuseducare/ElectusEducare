...
window.onload = function () {
	 document.getElementById("sectionselect").innerHTML="	<option value='0'  >--Select--</option>";
...
//Close filenames modal window
function closefilenamesmodel() {
	 var modal = document.getElementById('filenamesmodel');
	    modal.style.display = "none";
	}	
//Close filenames modal window
function closenoofmarkstypemodal() {
	 var modal = document.getElementById('noofmarkstypemodal');
	    modal.style.display = "none";
	}	
//Close filenames modal window
function closenoofnegmarkstypemodal() {
	 var modal = document.getElementById('noofnegmarkstypemodal');
	    modal.style.display = "none";
	}	


//Close positive marks modal window
function closepoistivemarksmodel() {
	 var modal = document.getElementById('positivemarksmadel');
	    modal.style.display = "none";
	}	
